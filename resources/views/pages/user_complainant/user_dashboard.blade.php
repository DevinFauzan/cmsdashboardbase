                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-sm btn-primary mdi mdi-plus mdi-18px float-end text-center " data-bs-toggle="modal" data-bs-target="#exampleModal">
                                New Ticket
                            </button>
                            </h4>
                            <div class="table-responsive">
                        ...
                        <div class="card-body">                         
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number_format" class="form-control" id="exampleInputTelp" placeholder="08xxxxx"
                                        >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName1">Complained date</label>
